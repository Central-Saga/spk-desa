...
class UpdateJadwalVisitasiRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $user?->can('jadwal-visitasi.update') ?? false;
    }
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $v) {
            $current = $this->route('jadwal_visitasi') ?? $this->route('jadwalVisitasi');
