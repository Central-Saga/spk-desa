...
@section('content')
    <div class="mb-4">
        <h1 class="h4 fw-semibold mb-1">Ubah Desa</h1>
        <p class="text-secondary mb-0 small">Perbarui data desa {{ $desa->nama }}.</p>
    </div>

    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            <form method="POST" action="{{ route('admin.desa.update', $desa) }}" novalidate>
                @csrf
                @method('PUT')
