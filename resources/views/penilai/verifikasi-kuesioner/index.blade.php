...
@section('content')
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <div>
            ...
            <p class="text-secondary mb-0 small">Pilih jadwal visitasi untuk memverifikasi jawaban kuesioner desa.</p>
        </div>
    </div>
                        ...
                        @forelse ($jadwal as $row)
                            <tr>
                                ...
                                <td class="text-end pe-3">
                                    <a href="{{ route('penilai.verifikasi-kuesioner.edit', $row) }}"
